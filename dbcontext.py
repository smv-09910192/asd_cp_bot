...
class DbContext:
    ...
    def get_all_invertors(self):
        invertorsData = self.service.spreadsheets().values().get(spreadsheetId="1B65wi55wfiTAPCzx21PqQG9bjBetZKy11j417R1ZUZU", range="Invertors!A2:D3").execute()
    ...
    def get_all_batteries(self):
        batteriesData = self.service.spreadsheets().values().get(spreadsheetId="1B65wi55wfiTAPCzx21PqQG9bjBetZKy11j417R1ZUZU", range="Batteries!A2:D3").execute()
